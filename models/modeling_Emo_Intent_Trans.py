...
class GPT2_backbone(GPT2PreTrainedModel):
    def __init__(self, config):
        super(GPT2_backbone, self).__init__(config)
    ...
    def forward(self, input_ids, cls_mask=None, past=None, attention_mask=None, token_type_ids=None,
...
class IntentEmo_Trans_GPT(GPT2PreTrainedModel):
    def __init__(self, config):
        super(IntentEmo_Trans_GPT, self).__init__(config)
        self.transformer = GPT2_backbone(config)
    ...
    def decoding(self, input_ids, past=None, cls_mask=None, token_type_ids=None, mode=0,
               current_emotion_latent=None, future_emotion_latent=None, intent_latent=None, sigma=None):
        transformer_outputs = self.transformer(input_ids=input_ids,
                                               cls_mask=cls_mask,
                                               past=past,
                                               attention_mask=None,
